...
var obras = [{ "codigo": 1, "nombre": "Maternidad", "descripcion": "La imagen de la maternidad es una de las más características de la época azul de Pablo Picasso (1901-1904): este cuadro corresponde a dicho periodo." }, { "codigo": 2, "nombre": "El Guernica", "descripcion": "Guernica es un famoso cuadro de Pablo Picasso, pintado entre los meses de mayo y junio de 1937, cuyo título alude al bombardeo de Guernica, ocurrido el 26 de abril de dicho año, durante la Guerra Civil Española." }, { "codigo": 3, "nombre": "Los tres músicos", "descripcion": "Este cuadro, pintado por Pablo Ruiz Picasso durante su estancia en Fontainebleau, en verano de 1921, es una de sus obras más célebres de lo que se ha llamado cubismo sintético" }];
...
(0, _jquery2.default)("#listadoObras div a:last-child").click(borrarVarios);
(0, _jquery2.default)("#tablaObras tbody").on("click", "td:last-child button:last-child", function () {
    //alert("has pulsado el boton de borrado");
    var codigo = (0, _jquery2.default)(this).parents("tr").find("input[type=checkbox]").val();
...
(0, _jquery2.default)("#tablaObras tbody").on("click", "td:last-child button:first-child", function () {
    alert("has pulsado el boton de actualizar");
    var codigo = (0, _jquery2.default)(this).parents("tr").find("input[type=checkbox]").val();
    var nombre = (0, _jquery2.default)(this).parents("tr").find("td:nth-child(2)").text();
    var descripcion = (0, _jquery2.default)(this).parents("tr").find("td:nth-child(3)").text();
...
},{"./pintores":4,"jquery":1}],4:[function(require,module,exports){
"use strict";
