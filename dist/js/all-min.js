...
var _pintores = require("./pintores");

var pintor = _interopRequireWildcard(_pintores);

var _obras = require("./obras");

var obra = _interopRequireWildcard(_obras);
...
var $listadoPintores = (0, _jquery2.default)("#listadoPintores");
...
var $listadoObras = (0, _jquery2.default)("#listadoObras");

if ($listadoObras.length) {
    var os = new obra.ObraService();
    os.getAll().then(function (data) {
...
var $contactForm = (0, _jquery2.default)("#contactForm");
/*
...
(0, _jquery2.default)("#listadoPintores div a:last-child").click(borrarVarios);
(0, _jquery2.default)("#tablaPintores tbody").on("click", "td:last-child button:last-child", function () {
...
(0, _jquery2.default)("#tablaPintores tbody").on("click", "td:last-child button:first-child", function () {
    alert("has pulsado el boton de actualizar");
    var codigo = (0, _jquery2.default)(this).parents("tr").find("input[type=checkbox]").val();
    var nombre = (0, _jquery2.default)(this).parents("tr").find("td:nth-child(2)").text();
    var descripcion = (0, _jquery2.default)(this).parents("tr").find("td:nth-child(3)").text();
});
/*
...
function borrarVarios() {
    ...
    (0, _jquery2.default)("#tablaPintores tbody input[type=checkbox]:checked").each(function () {
        var codigo = (0, _jquery2.default)(this).val();
        //llamar al rest
        (0, _jquery2.default)(this).parents("tr").remove();
        //actualizar el nº de pintores
    });
    (0, _jquery2.default)("#tablaObras tbody input[type=checkbox]:checked").each(function () {
        var codigo = (0, _jquery2.default)(this).val();
        //llamar al rest
        (0, _jquery2.default)(this).parents("tr").remove();
...
function validarFormularioContacto() {
    ...
    if (dniValido && nomValido && apeValido && teleValido) {
        ...
        if (!apeValido) {
            (0, _jquery2.default)("#apellidos").siblings("div.text-error").text("Los apellidos tienen que tener al menos de 2 letras");
        }
        if (!teleValido) {
            (0, _jquery2.default)("#telefono").siblings("div.text-error").text("El telefono no es valido, tiene que tener 9 digitos");
        }
    }
    return false;
}
...
function cargarArrayPintores(pintores) {
    ...
    if (pintores.length > 0) {
        for (var i = 0; i < pintores.length; i++) {
            ...
            (0, _jquery2.default)("#tablaPintores tbody").append(texto);
            //-->
        }
        (0, _jquery2.default)("#tablaPintores tfoot td").html("<span class='text-error'>Total pintores:</span>" + pintores.length);
    } else {
        (0, _jquery2.default)("#tablaPintores").remove();
        (0, _jquery2.default)("#listadoPintores").text("No se han encontrado pintores");
    }
}
...
function cargarArrayObras(obras) {
    ...
    if (obras.length > 0) {
        for (var i = 0; i < obras.length; i++) {
            ...
            //añadir el html correspondiente a la página
            (0, _jquery2.default)("#tablaObras tbody").append(texto);
            //-->
        }
        (0, _jquery2.default)("#tablaObras tfoot td").html("<span class='text-error'>Total obras:</span>" + obras.length);
    } else {
        (0, _jquery2.default)("#tablaObras").remove();
        (0, _jquery2.default)("#listadoObras").text("No se han encontrado obras");
    }
}
...
function validarDni(dni) {
    var valido = true;
    var pattern = new RegExp(/\d{8}[a-z][A-Z]/);
    if (pattern.test(dni)) {
...
},{"./obras":4,"./pintores":5,"jquery":1}],4:[function(require,module,exports){
/**
 * Created by Curso on 17/05/2017.
 */
"use strict";
...
exports.Obra = exports.ObraService = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _get = function get(object, property, receiver) { if (object === null) object = Function.prototype; var desc = Object.getOwnPropertyDescriptor(object, property); if (desc === undefined) { var parent = Object.getPrototypeOf(object); if (parent === null) { return undefined; } else { return get(parent, property, receiver); } } else if ("value" in desc) { return desc.value; } else { var getter = desc.get; if (getter === undefined) { return undefined; } return getter.call(receiver); } };

exports.rederizarFormulario = rederizarFormulario;
...
var urlObras = "http://localhost:8080/gestiongaleria/api/obras";

var ObraService = exports.ObraService = function (_service$GenericServi) {
    _inherits(ObraService, _service$GenericServi);

    function ObraService() {
        _classCallCheck(this, ObraService);

        var _this = _possibleConstructorReturn(this, (ObraService.__proto__ || Object.getPrototypeOf(ObraService)).call(this));
    ...
    _createClass(ObraService, [{
        ...
        value: function getAll() {
            return _get(ObraService.prototype.__proto__ || Object.getPrototypeOf(ObraService.prototype), "ajax", this).call(this, urlObras, "get", null);
        }
    }, {
        key: "getById",
        value: function getById(codigo) {
            return _get(ObraService.prototype.__proto__ || Object.getPrototypeOf(ObraService.prototype), "ajax", this).call(this, urlObras + "/" + codigo, "get", null);
        }
    }]);
...
function rederizarFormulario() {
    var codigo = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : -1;

    var os = new ObraService();
    var obra = new Obra();
    var txt = "";
    return new Promise(function (resolve, reject) {
        if (codigo > -1) {
            as.getById(codigo).then(function (obra) {
                txt = parseForm(obra);
                resolve(txt);
            }).catch(function () {
...
function renderizar() {
    ...
    return new Promise(function (resolve, reject) {
        as.getAll().then(function (data) {
            var obras = JSON.parse(data);
            if (obras.length > 0) {
                txt = "<table id='tablaObras' class='rwd-table'><thead><tr>" + "<th><input type='checkbox' name='borrartodos' id='borrartodos'/></th>" + "<th>Nombre</th>" + "<th>Descripcion</th>" + "<th></th></tr></thead><tbody>";
                for (var i = 0; i < obras.length; i++) {
                    var _obras = _obras[i];
                    console.log(obra);
                    txt += parseObra(obra);
...
function parseObra(obra) {
    ...
    var descripcion = obra.descripcion();
...
var Obra = exports.Obra = function () {
    function Obra(codigo, nombre, descripcion) {
...
},{"./genericservice":2}],5:[function(require,module,exports){
/**
 * Created by Curso on 17/05/2017.
 */
"use strict";
...
exports.Pintor = exports.PintorService = undefined;
...
var urlPintores = "http://localhost:8080/gestiongaleria/api/pintores";

var PintorService = exports.PintorService = function (_service$GenericServi) {
    _inherits(PintorService, _service$GenericServi);

    function PintorService() {
        _classCallCheck(this, PintorService);

        var _this = _possibleConstructorReturn(this, (PintorService.__proto__ || Object.getPrototypeOf(PintorService)).call(this));
    ...
    _createClass(PintorService, [{
        key: "getAll",
        value: function getAll() {
            return _get(PintorService.prototype.__proto__ || Object.getPrototypeOf(PintorService.prototype), "ajax", this).call(this, urlPintores, "get", null);
        }
    }, {
        key: "getById",
        value: function getById(codigo) {
            return _get(PintorService.prototype.__proto__ || Object.getPrototypeOf(PintorService.prototype), "ajax", this).call(this, urlPintores + "/" + codigo, "get", null);
        }
    }]);

    return PintorService;
}(service.GenericService);

var Pintor = exports.Pintor = function () {
    function Pintor(codigo, nombre, descripcion) {
        _classCallCheck(this, Pintor);
